...
## function calculates the inverse of the special "matrix" created with the function makeCacheMatrix.
...
## of the data and sets the value of the inverse in the cache via the setinv function.
